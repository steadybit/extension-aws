...
const (
	...
	apigatewayTargetType = "com.steadybit.extension_aws.apigateway"
)

// ApiGatewayThrottleAttackState captures the throttle config of an API Gateway stage so we can restore
